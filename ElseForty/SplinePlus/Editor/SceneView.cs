...
public class SceneViewDisplay
{
    ...
    static void SceneViewUI(SPData sPData, Node selectedNode)
    {
        ...
        {
            if (sPData.Nodes[i].Equals(null)) continue;
            var node2dPos = HandleUtility.WorldToGUIPoint(sPData.Nodes[i].Point.position);
    ...
    public static void Node_Type_Free(object obj)
    {
        ...
        Undo.RecordObject(sPData.SplinePlus, "Node insectType changed to free");
    ...
    public static void Spline_Close(object obj)
    {
        SPData sPData = (SPData)obj;
    ...
    public static void Spline_Open(object obj)
    {
        SPData sPData = (SPData)obj;
