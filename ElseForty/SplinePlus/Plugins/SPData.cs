...
namespace ElseForty
{
    ...
    public class SPData
    {
        public IMeshModifier MeshModifier;
        public IMeshUpdate MeshUpdate;
        ...
        public List<Vector3> VerticesCached = new List<Vector3>();
        ...
        public delegate void OnUpdateSpline();
        public static event OnUpdateSpline Update_Spline;

        public delegate void OnUpdateMesh();
        public static event OnUpdateMesh Update_Mesh;
